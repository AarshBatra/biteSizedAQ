...
-   Full blog post: [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/29.pib.pol.env.themes.log)

-   PIB India Environmental Press Releases Log Tracker Google Sheet: [Link](https://docs.google.com/spreadsheets/d/17l3TV2HKd0WfQz5OvB-bbIqGohB4Cs3LulZtjMYD3tU/edit?gid=1737040458#gid=1737040458)
...
Link to the full blog post: [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/28.coming.clean.about.the.planet)
...
-   Link to the full blog post: [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/27.same.number.four.diff.kinds.of.bad)
...
-   Link to the full blog post: [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/26.bite.sized.vis.6.aq.metadata.gap.filled)

-   Link to the underlying paper's (Renna et al) data file used to generate maps: [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/26.bite.sized.vis.6.aq.metadata.gap.filled/global_aq_mon_metadata/dataset)

-   Link to the full paper by Renna et al: [Link](https://www.nature.com/articles/s41597-026-06797-0)

-   Link to the my Rmd code for reproducing maps: [Link](https://github.com/AarshBatra/biteSizedAQ/blob/main/26.bite.sized.vis.6.aq.metadata.gap.filled.Rmd)
...
-   Read the full blog post: [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/25.first.resp.sensor.human.body.aq.toolkit)
...
-   **Read the full blog post:** [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/24.human.centric.aq.metrics)
...
-   Read the full blog here: [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/23.bite.sized.vis.5.aq.st.mth.yr.blk.compliance.chart)

-   The underlying data that powers the visualizations in this blog were processed and shared in biteSizedAQ - Project 22. Here is a [link to that project](https://github.com/AarshBatra/biteSizedAQ/tree/main/22.ind.block.mth.pm2.5.sat.data.processing.1998.2024).

-   Link to high res plots and animations: [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/23.bite.sized.vis.5.aq.st.mth.yr.blk.compliance.chart/images). Please feel free to share. But, if you do just link back and give credit to this original source (see License and Reuse section in the blog).

## Project 22: Block level Satellite derived population weighted Monthly PM2.5 dataset for India from 1998-2024

-   Read the blog post on [this link](https://github.com/AarshBatra/biteSizedAQ/tree/main/22.ind.block.mth.pm2.5.sat.data.processing.1998.2024).

-   Specifically explore the Northern Plains of India data in this [interactive data explorer](https://india-northern-plains-aq-explorer.lovable.app).
...
-   Animations of pollution race charts and other experimental resources: state wise, geographical region wise and airshed wise: [Link to Folder](https://github.com/AarshBatra/biteSizedAQ/tree/main/22.ind.block.mth.pm2.5.sat.data.processing.1998.2024/experimental.plots)

-   Subdistrict Level Monthly Compliance from 1998 to 2024 Plot: [Link to Folder](https://github.com/AarshBatra/biteSizedAQ/tree/main/22.ind.block.mth.pm2.5.sat.data.processing.1998.2024/experimental.plots).
