...
-   Link to the underlying paper's data file used to generate maps: [Link](https://github.com/AarshBatra/biteSizedAQ/tree/main/26.bite.sized.vis.6.aq.metadata.gap.filled/global_aq_mon_metadata/dataset)

-   Link to the code for reproducing maps: [Link](https://github.com/AarshBatra/biteSizedAQ/blob/main/26.bite.sized.vis.6.aq.metadata.gap.filled.Rmd)
