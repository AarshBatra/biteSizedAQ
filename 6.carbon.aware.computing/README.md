...
Big Tech’s accelerated adoption and marketing of carbon-aware computing
without any mention of its limitations or its risks of unintended
consequences is called Greenwashing.

Responsible carbon-aware computing has the potential to contribute to
greening tech emissions, but it is unconscionable to pursue it without
factoring in the risks; evidencing mitigation steps and actual impact;
and providing warning labels in its marketing and promotion.

Furthermore, even being both carbon-aware and grid-aware isn’t enough if
you overlook other critical factors like **water usage**. Many data
centers rely on significant amounts of water for cooling. If the focus
is only on reducing carbon emissions and managing grid demand, but not
on being **water-aware**, it can result in massive water losses. This is
