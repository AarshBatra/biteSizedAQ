...
If you are interested in reading more about the pipeline, continue reading the sections below, or access the full pipeline code here [UPDATE: ADD LINK]. Otherwise, you can directly start analyzing the data. Do check out the data dictionary section before starting analysis.

High resolution snapshots for all years, similar to the ones shown in the blog post can be found in this folder of the repo [UPDATE: ADD LINK]. Feel free to share this further for outreach or awareness purposes.
