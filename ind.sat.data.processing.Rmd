...
# load and document all functions
load_all()
document()
...
shrug_master_district_shp <- st_read("./data/raw/shrug/shrug_master_district_shp_with_uid_for_rast_wa.gpkg")

#> shrug subdistrict level shapefile with uid for rasterization
shrug_master_subdist_shp <- st_read("./data/raw/shrug/shrug_master_subdistrict_shp_with_uid_for_rast_wa.gpkg")
...
tic()
  ...
  print(str_c(cur_rast_year, " pm2.5 pol data processing r1 starts!"))
