...
The processed dataset resulting from this pipeline can be downloaded from this link. It can also be found under `data/processed/15.ind.block.mth.pm2.5.sat.data.processing.1998.2023`. The dataset is available in both long and wide form.
...
The data dictionary for both long and wide version of the processed block-month level PM2.5 dataset is available on this link.
