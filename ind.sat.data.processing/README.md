...
population raster data, processes it, and outputs summarized pollution
...
This pipeline is designed to process air pollution data from satellite
imagery and population data, generating a summary of pollution levels
weighted by population for different regions in India.
