...
- ***Renna, S., Rodriguez-Pardo, C. & Aleluia Reis, L***. A dataset of
  harmonized global air quality monitoring metadata. *Sci Data* **13**,
  466 (2026). <https://doi.org/10.1038/s41597-026-06797-0>

- ***2 Map Visuals in this blog**: github.com/AarshBatra/biteSizedAQ*
...
The Rmd file containing all analysis and code can be found here. It is
based on the data that can be found in this folder (i.e. the dataset
shared by this paper).
